<%-- 
    Document   : Admin Call Back
    Created on : Mar 15, 2024, 4:57:25 PM
    Author     : wfh_khan
--%>
<%        try {
...
<html lang="en">
    <head>
        ...
        <title>Admin | Call Back Data</title>
        <% } else { %>
        <title>Agent | Call Back Data</title>
        <% } %>
        ...
        <div class="wrapper">
            ...
            <div class="content-page" style="background-color: #e7e5e5;">
                <div class="content" style="background-color:none; margin-bottom: -24px;">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Call Back Data </h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                                ...
                                                <ul class="list-unstyled topbar-menu float-end mb-0"
                                                    ...
                                                    <li class="dropdown notification-list topbar-dropdown" style="background-color: #5ab7d3; height:40px; margin-left:0; border-radius:3px;">
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- item-->
                                                            <a href="Admin call back.jsp?value=smartcare" class="dropdown-item notify-item">
                                                                <i class="mdi mdi-file-document-edit-outline"></i>
                                                                <span class="align-middle"> Smartcare Call Back</span>
                                                            </a>
                                                            <!-- item-->
                                                            <a href="Admin call back.jsp?value=ecommerce" class="dropdown-item notify-item">
                                                                <i class="mdi mdi-file-document-edit-outline"></i>
                                                                <span class="align-middle"> E-Commerce Call Back</span>
                                                            </a>
                                                            <!-- item-->
                                                            <a href="Admin call back.jsp?value=language" class="dropdown-item notify-item">
                                                                <i class="mdi mdi-file-document-edit-outline"></i>
                                                                <span class="align-middle"> Language Call Back</span>
                                                            </a>
                                                            <!-- item-->
                                                            <a href="Admin call back.jsp?value=architech" class="dropdown-item notify-item">
                                                                <i class="mdi mdi-file-document-edit-outline"></i>
                                                                <span class="align-middle"> Architech Call Back</span>
                                                            </a>
                                                            <!-- item-->
                                                            <a href="Admin call back.jsp?value=diy" class="dropdown-item notify-item">
                                                                <i class="mdi mdi-file-document-edit-outline"></i>
                                                                <span class="align-middle"> DIY Call Back</span>
                                                            </a>
                                                        </div>
                                                    </li><li>
                                                        <% if (name != null && !name.isEmpty()) {%>
                                                        <a  href = "Admin add call back.jsp?value=<%= name%>">
                                                    ...
                                                    <li style="display: flex; justify-content: space-evenly; background-color: none;">
                                                        <form id="myForm" method="post" class="row gy-2 gx-2 align-items-center justify-content-around" action="ExportCallBack">
                    ...
                    <!-- smartcare, ecommerce, language, architech -->

                    <%
                        if (name.equals("smartcare")) {%>
                    <!-- table start -->
                    <div class="row" style="margin-top:5px; background-color: none; ">
                        <div class="page-title-box" style="background-color:none; margin-bottom:0px; height:60px; margin-top: -20px;">
                            <ul class="list-unstyled topbar-menu float-end mb-0" style="background-color: none; width: 100%; display:flex; justify-content: space-between;">
                                <li><h4 class="page-title">Smartcare Call Back</h4></li>
                                        ...
                                        <div class="tab-pane show active" id="responsive-preview">
                                            <div style="overflow-x:auto; overflow-y:auto;" class="appointment-table">
                                                <table class="table table-bordered table-centered mb-0" id="table">
                                                    ...
                                                    <tbody id="geeks">
                                                        <%int i = 1;
                                                            ResultSet rs = Table.smartcaretable.smartcare();
                                                            while (rs.next()) {%>
                                                        <tr>
                                                            <% if (Function.NewClass.getUserTypeFromTable(name_)) {%>
                                                            <td><a href="Edit call back.jsp?value=<%=request.getParameter("value")%>&val1=<%=rs.getString("id")%>">
                    ...
                    <!-- end row-->
                    <!-- samrtcare call back table end -->

                    <!-- table start -->
                    <!--                    <div class="row" style="margin-top:5px; background-color: none; ">
                                            <div class="page-title-box" style="background-color:none; margin-bottom:0px; height:60px; margin-top: -20px;">
                                                <ul class="list-unstyled topbar-menu float-end mb-0" style="background-color: none; width: 100%; display:flex; justify-content: space-between;">
                                                    <li><h4 class="page-title">E-Commerce Call Back</h4></li>
                                                    <li style="background-color: none; height: fit-content; margin-top: 15px;"><input id="gfg" class="int-productdata" type="text"
                                                                                                                                      placeholder="Search table data here..."></li>
                                                </ul>
                                            </div>
                                         ...
                                         E-commerce call back table end 
                    
                                         table start 
                                        <div class="row" style="margin-top:5px; background-color: none; ">
                                            <div class="page-title-box" style="background-color:none; margin-bottom:0px; height:60px; margin-top: -20px;">
                                                <ul class="list-unstyled topbar-menu float-end mb-0" style="background-color: none; width: 100%; display:flex; justify-content: space-between;">
                                                    <li><h4 class="page-title">Language Call Back</h4></li>
                                                    <li style="background-color: none; height: fit-content; margin-top: 15px;"><input id="gfg" class="int-productdata" type="text"
                                                                                                                                      placeholder="Search table data here..."></li>
                                                </ul>
                                            </div>
                                          ...
                                          Language call back table end 
                    
                                         table start 
                                        <div class="row" style="margin-top:5px; background-color: none; ">
                                            <div class="page-title-box" style="background-color:none; margin-bottom:0px; height:60px; margin-top: -20px;">
                                                <ul class="list-unstyled topbar-menu float-end mb-0" style="background-color: none; width: 100%; display:flex; justify-content: space-between;">
                                                    <li><h4 class="page-title">Architech Call Back</h4></li>
                                                    <li style="background-color: none; height: fit-content; margin-top: 15px;"><input id="gfg" class="int-productdata" type="text"
                                                                                                                                      placeholder="Search table data here..."></li>
                                                </ul>
                                            </div>
                                ...
                                <div class="tab-pane show active" id="responsive-preview">
                                    <div style="overflow-x:auto; overflow-y:auto;" class="appointment-table">
                                        <table class="table table-bordered table-centered mb-0" id="table">
                                            ...
                                            <tbody id="geeks">
                                                <%int j = 1;
                                                    ResultSet rs1 = Table.ecommercetable.ecommerce();
                                                    while (rs1.next()) {%>
                                                <tr>
                                                    <% if (Function.NewClass.getUserTypeFromTable(name_)) {%>
                                                    <td><a href="Edit call back.jsp?value=<%=request.getParameter("value")%>&val1=<%=rs1.getString("id")%>">
                                                            <i class="mdi mdi-pencil me-1"></i>
                                                        </a>
                                                    </td>
                                                    <% }%>
                                                    ...
                                                    <td><%= rs1.getString("call_type")%></td>
                                                    <td><%= rs1.getString("order_number")%></td>
                    ...
                    <div class="tab-pane show active" id="responsive-preview">
                        <div style="overflow-x:auto; overflow-y:auto;" class="appointment-table">
                            <table class="table table-bordered table-centered mb-0" id="table">
                                ...
                                <tbody id="geeks">
                                    <%int k = 1;
                                        ResultSet rs2 = Table.languagetable.language();
                                        while (rs2.next()) {
                                    %>
                                    <tr>
                                        <% if (Function.NewClass.getUserTypeFromTable(name_)) {%>
                                        <td><a href="Edit call back.jsp?value=<%=request.getParameter("value")%>&val1=<%=rs2.getString("id")%>">
                                                <i class="mdi mdi-pencil me-1"></i>
                                            </a>
                                        </td>
                                        <% }%>
                    ...
                    <div class="tab-pane show active" id="responsive-preview">
                        <div style="overflow-x:auto; overflow-y:auto;" class="appointment-table">
                            <table class="table table-bordered table-centered mb-0" id="table">
                                ...
                                <tbody id="geeks">
                                    <% int l = 1;
                                        ResultSet rs3 = Table.architechtable.architech();
                                        while (rs3.next()) {
                                    %>
                                    <tr>
                                        <% if (Function.NewClass.getUserTypeFromTable(name_)) {%>
                                        <td><a href="Edit call back.jsp?value=<%=request.getParameter("value")%>&val1=<%=rs3.getString("id")%>">
                                                <i class="mdi mdi-pencil me-1"></i>
                                            </a>
                                        </td>
                                        <% }%>
                                        ...
                                        <td><%= rs3.getString("customer_name")%></td>
                                        <td><%= rs3.getString("mobile_number")%></td>
                                        <td><%= rs3.getString("alternate_number")%></td>
                                        <td><%= rs3.getString("pincode")%></td>
                                        <td><%= rs3.getString("email_id")%></td>
                                        <td><%= rs3.getString("city")%></td>
                                        <td><%= rs3.getString("description")%></td>
                                        <td><%= rs3.getString("soa")%></td>
                                        <td><%= rs3.getString("agent_name")%></td>
                                        <td><%= rs3.getString("aspect_id")%></td>
                                    </tr>
                                </tbody>
                                <%}%>
                            </table>
...
<div class="row" style="margin-top:5px; background-color: none; ">
    <div class="page-title-box" style="background-color:none; margin-bottom:0px; height:60px; margin-top: -20px;">
        <ul class="list-unstyled topbar-menu float-end mb-0" style="background-color: none; width: 100%; display:flex; justify-content: space-between;">
            <li><h4 class="page-title">DIY Call Back Data</h4></li>
            <li style="background-color: none; height: fit-content; margin-top: 15px;"><input id="gfg" class="int-productdata" type="text"
                                                                                              placeholder="Search table data here..."></li>
        </ul>
    </div>
    <% List<Diy> diy = Function.NewClass.getDiy(); %>
    <div class="col-12">
        <div class="card">
            <div class="card-body" style="height:500px; background-color: none;">
                <div class="tab-content">
                        ...
                        <div style="overflow-x:auto; overflow-y:auto;" class="appointment-table">
                            <table class="table table-bordered table-centered mb-0" id="table">
                                ...
                                <tbody id="geeks">
                                    ...
                                    <tr>
                                        <% if (Function.NewClass.getUserTypeFromTable(name_)) {%>
                                        <td><a href="Edit call back.jsp?value=<%=request.getParameter("value")%>&val1=<%= e.getId()%>">
                                                <i class="mdi mdi-pencil me-1"></i>
                                            </a>
                                        </td>
                                        <%}%>
